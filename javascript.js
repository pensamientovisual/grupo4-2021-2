...
function an(){
    ...
    document.getElementById("areas_verdes").innerHTML = "Parques = 91 ha"
...
function co(){
    ...
    document.getElementById("areas_verdes").innerHTML = "Parques = 249 ha"
...
function rm(){
    ...
    document.getElementById("areas_verdes").innerHTML = "Parques = 2.477 ha"
...
function li(){
    ...
    document.getElementById("areas_verdes").innerHTML = "Parques = 184 ha"
...
function ml(){
    ...
    document.getElementById("areas_verdes").innerHTML = "Parques = 248 ha"
...
function bi(){
    ...
    document.getElementById("areas_verdes").innerHTML = "Parques = 427 ha"
...
function ar(){
    ...
    document.getElementById("areas_verdes").innerHTML = "Parques = 359 ha"
...
function lr(){
    ...
    document.getElementById("areas_verdes").innerHTML = "Parques = 291 ha"
...
function ll(){
    ...
    document.getElementById("areas_verdes").innerHTML = "Parques = 154 ha"
...
function ai(){
    ...
    document.getElementById("areas_verdes").innerHTML = "Parques = 64 ha"
...
function ma(){
    ...
    document.getElementById("areas_verdes").innerHTML = "Parques = 98 ha"
